...
(function () {
    var aMod_definer = function( theM_exceptiondetails,
        ...
        var aPathsLoader_Prototype = (function() {
            ...
            var _pInit = function( theTitle, thePathsName, theRootPath) {

                this._pInit_PathsLoader( theTitle, thePathsName, theRootPath);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_PathsLoader = function( theTitle, thePathsName, theRootPath) {

                /* Delegate on super prototype initialization */
                this._v_SuperPrototype._pInit_XLoader.apply( this, [ theTitle, thePathsName, theRootPath]);
            ...
            var fLoadPathsNamed = function( thePathsName, theRootPath) {
                ...
                var aLoadedPaths = this.fLoadXNamed( thePathsName, theRootPath);
                if( aLoadedPaths){}/* CQT */
            ...
            var pLoadPathsNamed = function( thePathsName, theCallback, theRootPath) {

                this._v_PathsName = thePathsName;
                this._v_RootPath  = theRootPath;

                this.pLoadXNamed( thePathsName, theCallback, theRootPath);
            };
            ...
            var pReplaceInPathsReceived = function(  theCallback, thePathsName, thePathsReceived, theMethodName) {
                ...
                somePackageNames[ theM_sentinels.ROOTPATHSTEPSYMBOL] = this._v_RootPath;
                someReplaceSteps[ theM_sentinels.ROOTPATHSTEPSYMBOL] = this._v_RootPath;
                        ...
                        if( aPathOrPaths) {
                            ...
                            if( typeof aPathOrPaths == "string") {
                                ...
                                if( !( aReplacedPathOrPaths == aPathOrPaths)) {
                                    aResAndPackagePathOrPaths[ "resPath_ORIG"] = aPathOrPaths;
                                    aResAndPackagePathOrPaths[ "resPath"]     = aReplacedPathOrPaths;
                                    aResAndPackagePathOrPaths[ "rootPath"]    = this._v_RootPath;
                                }
                            }
                            else {
        ...
        var PathsLoader_Constructor = function( theTitle, thePathsName, theRootPath) {
