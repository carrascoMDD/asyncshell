...
(function () {
    var aMod_definer = function( theM_exceptiondetails,
        ...
        var aXLoader_Prototype = (function() {
            ...
            var _pInit = function( theTitle, theNameToLoad, theRootToLoad) {

                this._pInit_XLoader( theTitle, theNameToLoad, theRootToLoad);
            };
            if( _pInit){}/* CQT */
            ...
            var _pInit_XLoader = function( theTitle, theNameToLoad, theRootToLoad) {
                ...
                this._v_RootToLoad = theRootToLoad;
            ...
            var fLoadXNamed = function( theNameToLoad, theRootToLoad) {
                ...
                if( !aXLoaded) {
                    console.log( ',{"msg": "FAILED XLOADER ' + aFullXPath + '"}');
                    return null;
                }

                console.log( ',{"msg": "OK XLOADER ' + aFullXPath + '"}');
            ...
            var pLoadXNamed = function( theNameToLoad, theCallback, theRootToLoad) {
                ...
                if( this.LOADX_FORCESYNC) {
                    var aXSyncLoaded = this.fLoadXNamed( this._v_NameToLoadReplaced, theRootToLoad);
                ...
                try {
                    if( this._v_NameToLoadReplaced.indexOf( this.PATHURLPREFIX) == 0) {
                        this.pLoadXNamed_async_remote( this._v_NameToLoadReplaced, aCallback, theRootToLoad);
                        return;
                    }

                    this.pLoadXNamed_async_local( this._v_NameToLoadReplaced, aCallback, theRootToLoad);
                }
                catch( anException) {
            ...
            var pLoadXNamed_async_local = function( theNameToLoad, theCallback, theRootToLoad) {
                ...
                theM_nextticker.pNextTick( function() {
                    var aRes = aThis.fLoadXNamed( theNameToLoad, theRootToLoad);
            ...
            var pLoadXNamed_async_remote = function( theNameToLoad, theCallback, theRootToLoad) {
        ...
        var XLoader_Constructor = function( theTitle, theNameToLoad, theRootToLoad) {
